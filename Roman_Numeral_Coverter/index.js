document.getElementById('convert-btn').addEventListener('click', function() {
    ...
    // Ensure the result is always visible
    ...
    if (!numberInput.trim()) {
        ...
        // Trigger animation after updating the result
        setTimeout(function() {
            outputDiv.style.opacity = 1; // Make the result visible
            outputDiv.classList.add('show-result');
        }, 50); // Small delay to ensure content is updated before animation starts
    }
});
